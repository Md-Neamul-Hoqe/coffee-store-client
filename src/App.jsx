  ...
  return (
    <>
      <div className="flex flex-col items-center gap-3">
        ...
        <Link
          to="/addCoffee"
          className="text-2xl font-rancho btn font-normal border-2 border-coffee-header-brown bg-yellow-600 text-white">
          Add Coffee <TbMug className="text-2xl text-coffee-header-brown" />
        </Link>
      </div>
      {typeof theCoffees === "object" ? (
        ...
        <div className="flex justify-center items-center min-h-screen">
          ...
          <p>The server may not start correctly.</p>
          <span className="loading loading-infinity text-accent w-32"></span>
        </div>
      )}

      <div className="flex flex-col items-center gap-3">
        <small className="text-xl leading-5 text-gray-900">Follow Us Now</small>
        <h1 className="text-5xl font-rancho text-coffee-header-brown drop-shadow-2xl relative blur-sm">
          Follow on Instagram
        </h1>
        <h1 className="text-5xl font-rancho text-coffee-header-brown absolute mt-8">
